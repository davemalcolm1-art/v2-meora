...
const Nav = () => {
  ...
  const navStyle: React.CSSProperties = {
    ...
    minWidth: 720,
    maxWidth: 1100,
    background: scrolled ? "rgba(26,43,53,0.55)" : "rgba(26,43,53,0.25)",
    backdropFilter: scrolled ? "blur(28px) saturate(160%)" : "blur(20px) saturate(140%)",
    WebkitBackdropFilter: scrolled ? "blur(28px) saturate(160%)" : "blur(20px) saturate(140%)",
