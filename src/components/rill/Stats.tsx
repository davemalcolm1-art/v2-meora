          ...
          {stats.map((s, i) => (
            <Fragment key={i}>
              ...
              <div style={{ textAlign: "center" }}>
                <div className="scroll-scale" style={{ fontFamily: "'Fraunces', serif", fontWeight: 700, fontSize: "clamp(48px,6vw,72px)", color: "#1A2B35", lineHeight: 1, transitionDelay: `${i * 120}ms` }}>{s.num}</div>
