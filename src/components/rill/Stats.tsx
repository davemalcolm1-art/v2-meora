    ...
    <section ref={sectionRef} className="scroll-animate" style={{ background: "#F7F4EF", padding: "120px 0" }}>
      <div className="stats-wrap" style={{ maxWidth: 1200, margin: "0 auto", padding: "0 80px" }}>
        <div style={{ marginBottom: 64, maxWidth: 720 }}>
          <div className="scroll-animate" style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(26,43,53,0.4)", marginBottom: 20 }}>THE OPPORTUNITY</div>
          <h2 className="scroll-animate delay-100" style={{ fontFamily: "'Fraunces', serif", fontWeight: 700, color: "#0f0f0f", fontSize: "clamp(36px,4vw,52px)", lineHeight: 1.1, letterSpacing: "-0.02em", margin: 0 }}>
            More years ahead.<br />
            <em style={{ fontStyle: "italic", color: "#FF5003" }}>Make them count.</em>
          </h2>
          <p className="scroll-animate delay-200" style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.75, color: "rgba(26,43,53,0.6)", marginTop: 16 }}>
          ...
          {stats.map((s, i) => (
            <Fragment key={i}>
              ...
              <div style={{ textAlign: "center" }}>
                <div className="scroll-scale" style={{ fontFamily: "'Fraunces', serif", fontWeight: 700, fontSize: "clamp(48px,6vw,72px)", color: "#0f0f0f", lineHeight: 1, transitionDelay: `${i * 120}ms` }}>{s.num}</div>
