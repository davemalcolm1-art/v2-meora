...
const ScienceCards = () => {
  ...
  return (
    <section ref={sectionRef} className="scroll-animate section-exit-blur sci-cards-section" style={{ position: "relative", width: "calc(100% - 96px)", margin: "0 48px", borderRadius: 32, background: `url(${BG}) center/cover no-repeat`, padding: "140px 0", overflow: "hidden" }}>
