...
const faqs = [
  ...
  { q: "What does the quarterly monitoring include?", a: "Every 90 days you complete a repeat blood panel at a private pathology clinic, followed by a follow-up telehealth consultation with your Meora doctor. Your results are reviewed, your dose is adjusted if needed, and a renewal prescription is issued. This ongoing monitoring is both a clinical requirement and the key to long-term results." },
